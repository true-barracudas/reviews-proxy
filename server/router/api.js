...
router.use('/products/:id/:username/helpful', createProxyMiddleware({ target: service4.url, changeOrigin: true }));
router.use('/products/:id/:username/nothelpful', createProxyMiddleware({ target: service4.url, changeOrigin: true }));
